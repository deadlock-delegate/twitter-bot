    ...
    start (options) {
        ...
        emitter.on('round.created', data => {
            ...
            for (const delegate of droppedOutDelegates) {
                ...
                this.tweet(`🚨 ${delegate} got removed from forging position by ARK holders in round ${round} #arkecosystem #dpos #arkdelegates #ARK $ARK #${timestamp}`)
            }
            ...
            for (const delegate of newDelegates) {
                ...
                this.tweet(`👏 ${delegate} got elected by ARK holders to be a forging delegate in round ${round} #arkecosystem #dpos #arkdelegates #ARK $ARK #${timestamp}`)
            }
